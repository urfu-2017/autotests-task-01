...
function getPokerHand(dice) {
    ...
    if (dice.some(i => isNaN(i) || !Number.isInteger(i) || i < 1 || i > 6))
        throw Error("dice array should contains only integer numbers in range [1..6]")
    ...
    switch(rawCounts.length) {
        ...
        // default branch redurant because it has proven that 
        //     no more than 5 values in rawCounts
