...
function getPokerHand(dice) {
    ...
    var check = false;
    var s = 0;
    var result = ['Пара','Тройка','Каре','Покер','Две пары','Фулл хаус','Наивысшее очко'];
    ...
    {
        if(dice[i]<1 || dice[i]>6 || !Number.isInteger(dice[i]))
        throw new TypeError('The dice must be no more than 6 and not less than 1 and be an integer');
    }
