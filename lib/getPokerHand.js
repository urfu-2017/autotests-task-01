...
function getPokerHand(dice) {
    ...
    dice.forEach(nValue => {
        if (typeof nValue !== 'number') {
            ...
            throw new Error('One or more elements in array is not a number');
        }
        if ((nValue < 1 || nValue > 6) || (nValue % 1 !== 0)){
            throw new Error('One or more elements in array is out of range');
        }
...
// const diceCheck = [3, 2, 3, 3, 5, 4, 5, 1];
// console.log(getPokerHand(diceCheck));
