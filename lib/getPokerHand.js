...
function getPokerHand(dice) {
    ...
    if (dice.some(value => !Number.isInteger(value))) throw new Error('Значения должны быть целыми!');
    if (dice.some(value => 1 > value || value > 6)) throw new Error('Значения должны быть от 1 до 6!');
