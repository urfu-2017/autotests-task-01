...
describe('getPokerHand', () => {
	...
	describe('Not Positive', () =>{
		...
		it('should return `Element is `Cell of array is fraction` for [0.8, 2, 3, 4, 5]', () =>{
			const actual = () => getPokerHand([0.8, 2, 3, 4, 5]);

			assert.equal(actual, /Cell of array is fraction/);
		});  
	});
